...
public class MyAdviceRecyclerViewAdapter
    extends RecyclerView.Adapter<MyAdviceRecyclerViewAdapter.ViewHolder> {

  private final List<AdviceEntity> mValues;
  private final OnListFragmentInteractionListener mListener;

  public MyAdviceRecyclerViewAdapter(
      List<AdviceEntity> items, OnListFragmentInteractionListener listener) {
    mValues = items;
    mListener = listener;
  }
